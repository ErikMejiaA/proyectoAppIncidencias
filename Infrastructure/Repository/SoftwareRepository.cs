...
public class SoftwareRepository : ISoftwareInterface
{
    protected readonly proyectoAppInsidenciasContext _context;

    public SoftwareRepository(proyectoAppInsidenciasContext context)
    {
        _context = context;
    }
    ...
    public async Task<Software> GetByIdAsync(string id)
    {
